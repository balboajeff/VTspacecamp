// Controlled Release code for Altitude-based Servo release.  This should be tested on site!!!
...
////////////CHANGE THIS BASED ON LAUNCH DAY PREDICTIONS////////
 int target = 248;
//10000 meters = 32800 feet
#include <Wire.h>
...
///////////SERIAL CODE TO CHECK LAUNCH SITE ELEVATION AND TEST THE MECHANISM.  MAKE SURE THE “servo.write” lines move the servo to the correct position to close and open around the flight line.///////////
...
//myservo.write(90); //Uncomment this line only to test servo in closed position is closed

  if(altitude >= target&& digitalRead(8)==LOW){
